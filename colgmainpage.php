...
<?php
	...
	$result=mysqli_query($SYSCONN,"SELECT collegename,about FROM colleges WHERE collegecode='".$_GET['colgcode']."';") or systemlog($_SERVER['PHP_SELF']."  SQL query error: ".mysqli_error($SYSCONN));	//collegecode is primary, so only 1 returned.
