...
$CONN = db_sysconnect();
$result = mysqli_query($CONN,"SELECT * FROM posts,postdata WHERE posts.postid=postdata.postid and posts.postid=".$_GET['postid'].";") or systemlog($_SERVER['PHP_SELF']."  SQL query error: ".mysqli_error($CONN));
