...
if(isset($_SESSION['uid']) and (isColgAdmin($_SESSION['uid']) or isSiteAdmin($_SESSION['uid'])))
{
	...
	mysqli_query($CONN,"UPDATE colleges SET about='".$aboutdata."',collegename='".$colgname."' WHERE collegecode='".$_SESSION['tempcolgcode']."';") or systemlog("SQL query error: ".mysqli_error($CONN)); //and die?? TODO
